        ...
        http
                ...
                .authorizeRequests()
                    ...
                    .antMatchers(HttpMethod.GET, "/api/users/**")
                        .permitAll()
                   .antMatchers(HttpMethod.POST, "/signup/**", "/api/users/**")
                        .permitAll()
                  .antMatchers(HttpMethod.GET, "/signup/**", "/api/users/**")
                        .permitAll()
                 .antMatchers(HttpMethod.GET, "/login/**", "/api/users/**")
                        .permitAll()
                  .antMatchers(HttpMethod.GET, "/", "/home/**", "/api/users/**")
                        .permitAll()                       
                    .anyRequest()
                        .authenticated();
